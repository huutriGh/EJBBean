...
a persistence unit "EJBBeanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EJBBean/pom.xml":
...
artifacts ("EJBBean-ejb.jar" and "EJBBean-web.war") are already built. You can build
